...
curl_tar 'https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.7/cmake-19.1.7.src.tar.xz' \
  "${LLVM_PATH}/cmake" 1
curl_tar 'https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.7/compiler-rt-19.1.7.src.tar.xz' \
...
cmake_config=(
  ...
  -DCMAKE_INSTALL_PREFIX="${LLVM_PATH}/lib/clang/19"
...
done < <(find "${LLVM_PATH}/lib/clang/19/lib/darwin/" -name 'libclang_rt.*')
